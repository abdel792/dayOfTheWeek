...
* Der erste namens "Einen Tag suchen" öffnet einen Dialog, der aus 3 Steuerelementen besteht:
    ...
    * Eine "Abbrechen"-Schaltfläche zum Schließen des Dialogs.
...
* Der zweite namens "Einstellungen der Wochentag-Erweiterung" öffnet die Parameter der Erweiterung, um festzulegen, ob Sie Beschriftungen für Datumsfelder angesagt bekommen möchten oder nicht. Er besteht aus folgenden Elementen:
    ...
    * Eine "Abbrechen"-Schaltfläche zum Abbrechen und Schließen des Dialogs.

## Hinweise ##

* Sie können diese Dialoge einfach durch Drücken der Eingabetaste (Escape) schließen;
...
* Die Wochentage wurden übersetzt, damit die Erweiterung in den verschiedenen Sprachen ordnungsgemäß funktioniert;
